...
- (void)requestPost {
    ...
    [request sendRequest:^(id<NSObject> body) {
        ...
        [self.post applyDict:(NSDictionary *)body];
...
- (void)addThreadToPost:(Thread *)thread {
    ...
    [request sendRequest:^(id<NSObject> body) {
        ...
        Thread *thread = [Thread fromDict:(NSDictionary *)body];
...
- (void)addMessage:(Message *)message toThread:(Thread *)thread {
    ...
    [request sendRequest:^(id<NSObject> body) {
        ...
        Message *message = [Message fromDict:(NSDictionary *)body];
