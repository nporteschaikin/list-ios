...
- (void)layoutSubviews {
    ...
    h = [self.contentLabel sizeThatFits:CGSizeMake(w, 0.0f)].height;
...
- (CGSize)sizeThatFits:(CGSize)size {
    CGFloat height = NotificationsTableViewCellPadding;
    height += fmaxf(NotificationsTableViewCellAvatarImageViewSize, CGRectGetHeight(self.contentLabel.frame) + CGRectGetHeight(self.dateLabel.frame));
    height += NotificationsTableViewCellPadding;
