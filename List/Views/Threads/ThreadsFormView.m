...
- (UIButton *)privacyButton {
    if (!_privacyButton) {
        ...
        [_privacyButton setImage:[UIImage list_imageForIcon:LIconPeople size:25.f color:[UIColor list_blueColorAlpha:1]]
                        forState:UIControlStateNormal];
        [_privacyButton setImage:[UIImage list_imageForIcon:LIconPerson size:25.f color:[UIColor list_blueColorAlpha:1]]
