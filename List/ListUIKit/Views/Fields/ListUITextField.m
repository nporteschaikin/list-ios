...
- (void)setPlaceholder:(NSString *)placeholder {
    ...
    self.attributedPlaceholder = [[NSAttributedString alloc] initWithString:placeholder attributes:@{NSForegroundColorAttributeName:[UIColor listUI_colorWithHex:0xC7C7C7 alpha:1.0F]}];
